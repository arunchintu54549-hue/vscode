...
const aiIconUri = FileAccess.asBrowserUri('Aibot.png' as AppResourcePath);
const aiIcon = { dark: aiIconUri, light: aiIconUri };
...
MenuRegistry.appendMenuItems([
	{
		...
		item: {
			...
			command: {
				...
				toggled: { condition: AuxiliaryBarVisibleContext, icon: aiIcon },
				icon: aiIcon,
			},
